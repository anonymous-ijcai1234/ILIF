...
def main():
    ...
    parser.add_argument('-surrogate', default='sigmoid', type=str, help='used surrogate function. should be sigmoid, rectangle, or triangle')
    ...
    parser.add_argument('-neuron_model', type=str, default='ILIF', help='save the initialization of parameters')
    parser.add_argument('-multiple_step', type=bool, default=True, help='whether multiple steps')
    ...
    if args.surrogate == 'sigmoid':
        surrogate_function = surrogate_sj.Sigmoid(alpha=4)
    elif args.surrogate == 'rectangle':
        surrogate_function = surrogate_self.Rectangle(alpha=1)
